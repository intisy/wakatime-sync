...
import { shouldRunClaudeHook } from "./host.js";
...
defineReadme({
  ...
  architecture: `flowchart TD
    ...
    subgraph Shared [Shared basekit]
  ...
  dependencies: ["basekit", "wakatime-cli", "@opencode-ai/plugin"],
  extraSections: [
    {
      id: "api-key",
      title: "API Key Setup",
...
// plugin stays exported too: OpenCode invokes every exported function, while an api host reads the default.
